...
class TestRasterizeSilhouettes(unittest.TestCase):
    ...
    def test_backward_case1(self):
        ...
        vertices = [[0.8, 0.8, 1.0], [0.0, -0.5, 1.0], [0.2, -0.4, 1.0]]
        faces = [[0, 1, 2]]
        pxi = 35
        pyi = 25
        grad_ref = [
            [1.6725862, -0.26021874, 0.0],
            [1.41986704, -1.64284933, 0.0],
            [0.0, 0.0, 0.0],
        ]
    ...
    def test_backward_case2(self):
        ...
        vertices = [[0.8, 0.8, 1.0], [-0.5, -0.8, 1.0], [0.8, -0.8, 1.0]]
        faces = [[0, 1, 2]]
        pyi = 40
        pxi = 50
        grad_ref = [
            [0.98646867, 1.04628897, 0.0],
            [-1.03415668, -0.10403691, 0.0],
            [3.00094461, -1.55173182, 0.0],
        ]
